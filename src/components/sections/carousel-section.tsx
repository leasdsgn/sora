    ...
    <section ref={sectionRef} className="relative bg-secondary overflow-hidden">
      <div className="h-auto md:h-screen flex flex-col pb-12 md:pb-0">
        <div className="pt-24 pb-10 px-8 md:px-12 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            <p className="eyebrow text-muted-foreground mb-4">Opérations et visuels de projet</p>
            ...
            {REALISATIONS.map((r, i) => (
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 text-foreground">
                  ...
                  <p className="text-sm text-foreground/70">{r.caption}</p>
                </div>
                <Badge variant="outline" className="absolute top-4 right-4 bg-background/70 backdrop-blur-sm border-foreground/20 text-foreground/70">
