...
export default function FounderSection() {
 ...
 <section ref={ref} id="fondateur" className="bg-bg-mid py-24 md:py-36 px-6">
  ...
  {ITEMS.map((it, i) => (
   ...
   <span className="metadata text-ink/60">0{i + 1}</span>
   <div>
  ...
  <div className="md:col-span-8">
   <p className="tertiary text-ink/60 mb-3">Le fondateur</p>
   <h3 className="font-serif text-3xl md:text-4xl text-ink mb-3">Gabriel Lapierre</h3>
	   ...
	   <p className="metadata text-ink/60">Gabriel Lapierre, fondateur</p>
  </div>
  </div>
 </section>
 )
